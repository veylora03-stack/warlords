...
const IP = '203.0.144.1' // unique per file: shared pools trip AUTH_RATE_LIMIT across parallel suites
let regIpCounter = 1
const nextRegIp = (): string => `203.0.144.${regIpCounter++}` // rotate per auth call — the auth limiter is per-IP (10/60s)
