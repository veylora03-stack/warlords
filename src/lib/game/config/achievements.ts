...
export const ACHIEVEMENTS: AchievementCatalogEntry[] = [
  ...
  // ── Phase 33 — march engine (STAT metrics recorded by march.service) ──────
  {
    id: 'ach-pathfinder',
    title: 'Pathfinder',
    description: 'Complete your first march. The roads know your banner now.',
    category: 'MILITARY',
    metric: 'STAT',
    meta: { statKey: 'marchesCompleted' },
    target: 1,
    reward: { GEMS: 10, XP: 60 },
  },
  {
    id: 'ach-scout-10',
    title: 'Eyes of the Realm',
    description: 'Scout 10 territories. Nothing moves without you knowing.',
    category: 'MILITARY',
    metric: 'STAT',
    meta: { statKey: 'marchesScouted' },
    target: 10,
  ...
  },
  {
    id: 'ach-marcher-25',
    title: 'Road Warrior',
    description: 'Complete 25 marches. The war effort runs on your columns.',
    category: 'MILITARY',
    metric: 'STAT',
    meta: { statKey: 'marchesCompleted' },
    target: 25,
    reward: { GEMS: 60, XP: 350 },
  },
  {
    id: 'ach-march-victor-10',
    title: 'Campaigner',
    description: 'Win 10 march battles. Your expeditions return victorious.',
    category: 'MILITARY',
    metric: 'STAT',
    meta: { statKey: 'marchBattlesWon' },
    target: 10,
