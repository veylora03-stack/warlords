...
export const STAT_DEFINITIONS: readonly StatDefinition[] = [
  ...
  { key: 'marchesLaunched', label: 'Marches launched', category: 'COMBAT' },
  { key: 'marchesCompleted', label: 'Marches completed', category: 'COMBAT' },
  { key: 'marchesScouted', label: 'Territories scouted', category: 'COMBAT' },
  { key: 'marchBattlesWon', label: 'March battles won', category: 'COMBAT' },
  { key: 'unitsTrained', label: 'Units trained', category: 'COMBAT' },
  { key: 'unitsLost', label: 'Units lost', category: 'COMBAT' },
  { key: 'garrisonsDeployed', label: 'Garrisons deployed', category: 'COMBAT' },
  { key: 'garrisonWithdrawals', label: 'Garrisons withdrawn', category: 'COMBAT' },
  { key: 'clansJoined', label: 'Clans joined', category: 'PROGRESSION' },
